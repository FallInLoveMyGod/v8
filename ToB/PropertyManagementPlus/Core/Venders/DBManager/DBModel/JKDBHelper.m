...
+ (NSString *)dbPathWithDirectoryName:(NSString *)directoryName
{
    ...
    if (directoryName == nil || directoryName.length == 0) {
        ...
        NSString *jsonString = [defaultSet valueForKey:[LocalStoreData LoginInfoKey]];
        NSData *jsonData = [jsonString dataUsingEncoding:NSUTF8StringEncoding];
        NSError *err;
        
        if (jsonData == nil) {
            docsdir = [docsdir stringByAppendingPathComponent:@"PropertyManagementPlus"];
        }else {
            ...
            if(err) {
                ...
                docsdir = [docsdir stringByAppendingPathComponent:dic[@"upk"]];
            }
        }
    } else {
    ...
    NSString *dbpath = [docsdir stringByAppendingPathComponent:@"PropertyManagementPlus.sqlite"];
    return dbpath;
}
