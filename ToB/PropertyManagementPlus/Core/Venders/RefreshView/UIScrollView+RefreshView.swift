...
extension UIScrollView {
    ...
    /// 下拉刷新
    public var zj_refreshHeader: RefreshView? {
        set {
    ...
    /// 上拉刷新
    public var zj_refreshFooter: RefreshView? {
        set {
    ...
    /// 开启header刷新
    @objc public func zj_startHeaderAnimation() {
        zj_refreshHeader?.canBegin = true
    }
    /// 结束header刷新
    @objc public func zj_stopHeaderAnimation() {
        zj_refreshHeader?.canBegin = false
    }
    /// 开启footer刷新
    @objc public func zj_startFooterAnimation() {
        zj_refreshFooter?.canBegin = true
    }
    /// 结束footer刷新
    @objc public func zj_stopFooterAnimation() {
