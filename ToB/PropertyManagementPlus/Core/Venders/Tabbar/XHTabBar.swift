...
extension XHTabBar{
     ...
     *  - param: index 位置
     */
    open func showBadgeMark(_ badge: Int, index: Int) {
     ...
     *  - param: index 位置
     */
    open func showPointMarkIndex(_ index: Int) {
        guard index < controllerArray.count else
        {
            print("error:index="+"\(index)"+"超出范围")
            return;
     ...
     *  - param: index 位置
     */
    open func hideMarkIndex(_ index: Int) {
        guard index < controllerArray.count else
        {
            print("error:index="+"\(index)"+"超出范围")
            return;
...
open class XHTabBar:UITabBarController {
     ...
     *  - param: index 位置
     */
    open func showControllerIndex(_ index: Int) {
    ...
    open func hide() {
        ...
        UIView.animate(withDuration: 0.5, animations: {() -> Void in
            ...
            self.tabBar.frame = CGRect(x: 0, y: kScreenHeight, width: kScreenWidth, height: kTabBarHeight)
    ...
    open func show() {
        ...
        UIView.animate(withDuration: 0.5, animations: {() -> Void in
            ...
            self.tabBar.frame = CGRect(x: 0, y: kScreenHeight - kTabBarHeight, width: kScreenWidth, height: kTabBarHeight)
