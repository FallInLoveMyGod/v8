...
open class SMSegmentAppearance {
    ...
    internal init() {
        ...
        self.segmentTouchDownColour = self.segmentOffSelectionColour
    ...
    internal init(contentVerticalMargin: CGFloat, segmentOnSelectionColour: UIColor, segmentOffSelectionColour: UIColor, titleOnSelectionColour: UIColor, titleOffSelectionColour: UIColor, segmentTouchDownColour: UIColor, titleOnSelectionFont: UIFont, titleOffSelectionFont: UIFont) {
