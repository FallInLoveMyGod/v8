...
open class SMSegment: UIView {
    ...
    open override func layoutSubviews() {
        ...
        self.label.frame = CGRect(x: imageViewFrame.origin.x + imageViewFrame.size.width + distanceBetween - 10, y: verticalMargin, width: self.label.frame.size.width + 20, height: self.frame.size.height - verticalMargin * 2)
    }
    ...
    @objc internal func tapGesAction() {
