...
@interface LSDatePicker : UIView<UIPickerViewDataSource,UIPickerViewDelegate>
...
@property (nonatomic, strong) UILabel* tempHintsLabel;
...
//重置
- (void)resetButtonClickWithDataPicker:(LSDatePicker*)picker;
/**
 * 点击确定后的事件
 */
@optional
-(void)DatePickerDelegateEnterActionWithDataPicker:(LSDatePicker*)picker;

/**
 * 组件滑动
 */
@optional
- (void)selectItemPickerDelegate:(LSDatePicker*)picker;
