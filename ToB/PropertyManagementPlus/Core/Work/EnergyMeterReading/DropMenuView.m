...
-(void)creatDropView:(UIView *)view withShowTableNum:(NSInteger)tableNum withData:(NSArray *)arr selectIndex:(NSInteger)selectIndex{
    ...
    if (!self.show) {
        ...
        if (selectIndex == 3) {
           self.tableViewUnderView.frame = CGRectMake(0, 0, self.frame.size.width, self.rowHeightNum * 7);
            ...
            self.tableViewUnderView.frame = CGRectMake(0, 0, self.frame.size.width, self.rowHeightNum * 4);
        }
