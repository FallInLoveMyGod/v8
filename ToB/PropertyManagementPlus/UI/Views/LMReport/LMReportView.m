...
- (void)layoutSubviews {
    ...
    _topLeftView.frame = CGRectMake(0, 0, 0, _topLeftView.frame.size.height);
    ...
    _topRightScroll.frame = CGRectMake(0.5, rect.origin.y, rect.size.width + rect.origin.x - 0.5, rect.size.height);
    ...
    _bottomRightScroll.frame = CGRectMake(0.5, rect.origin.y, rect.size.width + rect.origin.x - 0.5, rect.size.height);
