...
//        self.iconView.backgroundColor = [UIColor colorWithRed:224/255.0 green:224/255.0 blue:224/255.0 alpha:1.0f];
        ...
        self.chatName.text  = [NSString stringWithFormat:@"%@",model.personName];
        self.iconView.image = nil;
        if ([model.type intValue] == 1) {
            self.iconView.image = [UIImage imageNamed:@"icon_person_owner"];
        }else {
            self.iconView.image = [UIImage imageNamed:@"icon_person"];
        }
...
- (UILabel *)titleErrorLable
{
    if (_titleErrorLable == nil) {
        _titleErrorLable = [[UILabel alloc] initWithFrame:CGRectMake(0,0, SCREENWIDTH, 30)];
...
- (UIImageView *)logImgView
{
    if (_logImgView == nil) {
        ...
        _logImgView.center = CGPointMake(SCREENWIDTH/2.0f, (SCREENHEIGHT-64)/2.0f-64);
...
{
    if (_errorView == nil) {
        _errorView = [[UIView alloc] initWithFrame:CGRectMake(0,0, SCREENWIDTH, SCREENHEIGHT-40-64-40)];
        _errorView.tag = 2345;
