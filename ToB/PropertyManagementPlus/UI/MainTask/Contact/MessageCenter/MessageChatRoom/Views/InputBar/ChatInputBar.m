...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if (!self.inputTextView.text || [self.inputTextView.text isEqualToString:@""]) {
        [_sendButton setImage:[UIImage imageNamed:@"icon_send_normal"] forState:UIControlStateNormal];
    }else {
        [_sendButton setImage:[UIImage imageNamed:@"icon_send_pressed"] forState:UIControlStateNormal];
    }
    // frame 改变
...
- (void)sendButtonAction {
    ...
    if (self.isCanSendMessage == NO || !self.inputTextView.text || [self.inputTextView.text isEqualToString:@""]) {
        return;
    }
