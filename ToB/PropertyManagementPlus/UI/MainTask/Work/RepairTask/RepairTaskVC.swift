...
//
//  Created by 上海乐软信息科技有限公司 on 2018/4/4.
...
class RepairTaskVC: BaseTableViewController,FJFloatingViewDelegate {
    ...
    override func requestData() {
        ...
        if (selectIndex == 0 || selectIndex == -1) {
            ...
            let arr = ["AccountCode":loginInfo?.accountCode ?? "","upk":userInfo?.upk ?? "","type":contentType]
            print(arr);
